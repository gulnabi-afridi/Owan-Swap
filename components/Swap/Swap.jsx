      ...
      <div className="w-full bg-[black] max-w-xs sm:max-w-sm rounded-2xl flex flex-col items-center justify-center m-auto full-shadow border-[2px] border-solid border-[white]">
        ...
        <div className="w-full rounded-t-2xl  py-4 px-4 flex flex-col items-center justify-center gap-3 border-solid border-0 border-b border-[rgb(231,227,235)]">
          <div className="w-full flex  items-center justify-between   ">
            <h2 className="font-semibold text-xl text-[#FFAA27]">Swap</h2>
            {/* => Right icons */}
            <div className="flex items-center gap-[6px]">
              <SettingsIcon className="cursor-pointer fill-[#FFAA27] hover:opacity-50" />
              <RestoreIcon className="cursor-pointer fill-[#FFAA27] hover:opacity-50  " />
              <RefreshIcon className="cursor-pointer fill-[#FFAA27] hover:opacity-50" />
            </div>
          </div>
          <p className="text-[#FFAA27] text-md">Trade tokens in an instant</p>
        </div>
        {/* => Swaping boxes */}
        <div className="w-full py-4 pb-8 px-4 flex flex-col items-center justify-between gap-16  rounded-b-xl">
          <div className="w-full flex flex-col items-center justify-between gap-3 ">
            ...
            <div className="w-full flex flex-col items-start justify-center gap-1">
              ...
              >
                ...
                <div className=" flex items-center justify-center  cursor-pointer">
                  <h4 className="text-[#FFAA27] text-md font-semibold uppercase">
                    {Sec_Coin.title}
                  </h4>
                  <ExpandMoreIcon className="text-[#FFAA27]" />
                </div>
                <ContentCopyIcon className="cursor-pointer fill-[#FFAA27]" />
              </div>
              {/* input 2 */}
              <input
                type="text"
              ...
              <div className="w-full flex items-center justify-between px-4 pt-4">
                ...
                <div className="flex items-center justify-center gap-3">
                  <p className="text-[16px] font-normal text-[#FFAA27]">
                    0.56466 BNB per OVE
                  </p>
                  <AutorenewIcon className="text-[18px] text-[#FFAA27]" />
                </div>
              </div>
              {/* ========>Slipage tolerance */}
              <div className="w-full flex items-center justify-between px-4 py-2">
                ...
                <div className="text-lg text-[#FFAA27] font-semibold ">
                  0.5%
                </div>
              </div>
            </div>
          ...
          <button
            ...
            className="w-[80%] rounded-[25px] bg-[#FFAA27] py-3 px-5 text-[black] font-semibold hover:opacity-80 transition-all duration-500"
          >
            Connect Wallet
          </button>
        </div>
      ...
      <div className="w-full max-w-xs sm:max-w-sm rounded-2xl m-auto my-4 bg-[black] p-5 flex flex-col gap-1 justify-start items-center full-shadow border-[2px] border-solid border-[white]">
        ...
        <div className="w-full flex justify-between items-center">
          <p className="text-[#FFAA27] text-[14px] flex justify-center items-center gap-2">
            Minimum received
            <HelpOutlineIcon className="text-[16px] text-[#FFAA27]" />
          </p>
          <p className="text-[#FFAA27] text-[16px] flex justify-center items-center">
            77.84 OVE
          </p>
        </div>
        {/* Price Impact  */}
