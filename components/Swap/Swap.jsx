      ...
      <div className="w-full bg-[black] max-w-xs sm:max-w-sm rounded-2xl flex flex-col items-center justify-center m-auto full-shadow border-[2px] border-solid border-[white]">
        ...
        <div className="w-full rounded-t-2xl  py-4 px-4 flex flex-col items-center justify-center gap-3 border-solid border-0 border-b border-[rgb(231,227,235)]">
          <div className="w-full flex  items-center justify-between   ">
            <h2 className="font-semibold text-xl text-pink">Swap</h2>
            {/* => Right icons */}
            <div className="flex items-center gap-[6px]">
              <SettingsIcon className="cursor-pointer fill-pink hover:opacity-50" />
              <RestoreIcon className="cursor-pointer fill-pink hover:opacity-50  " />
              <RefreshIcon className="cursor-pointer fill-pink hover:opacity-50" />
            </div>
          </div>
          ...
          <div className="w-full flex flex-col items-center justify-between gap-3 ">
            ...
            <div className="w-full flex flex-col items-start justify-center gap-1">
              ...
              >
                ...
                <div className=" flex items-center justify-center  cursor-pointer">
                  <h4 className="text-pink text-md font-semibold uppercase">
                    {Sec_Coin.title}
                  </h4>
                  <ExpandMoreIcon className="text-pink" />
                </div>
                <ContentCopyIcon className="cursor-pointer fill-pink" />
              </div>
              {/* input 2 */}
              <input
                type="text"
              ...
              <div className="w-full flex items-center justify-between px-4 pt-4">
                ...
                <div className="flex items-center justify-center gap-3">
                  <p className="text-[16px] font-normal text-pink">
                    0.56466 BNB per OVE
                  </p>
                  <AutorenewIcon className="text-[18px] text-pink" />
                </div>
              </div>
              {/* ========>Slipage tolerance */}
      ...
      <div className="w-full max-w-xs sm:max-w-sm rounded-2xl m-auto my-4 bg-[black] p-5 flex flex-col gap-1 justify-start items-center full-shadow border-[2px] border-solid border-[white]">
        ...
        <div className="w-full flex justify-between items-center">
          <p className="text-pink text-[14px] flex justify-center items-center gap-2">
            Minimum received
            <HelpOutlineIcon className="text-[16px] text-pink" />
          </p>
          <p className="text-pink text-[16px] flex justify-center items-center">
            77.84 OVE
          </p>
        </div>
        {/* Price Impact  */}
