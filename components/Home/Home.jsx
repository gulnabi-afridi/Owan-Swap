    ...
    <div className="w-full h-screen bg-white dark:bg-black">
      <div className="w-full h-full max-w-[1200px] m-auto flex flex-col gap-24 md:gap-0 md:flex-row justify-center items-center px-6 xl:px-0">
        ...
        <div className="md:w-[50%] w-full flex flex-col justify-center items-center md:items-start gap-4 md:gap-7">
          ...
          <p className="text-[16px] md:text-[20px] lg:text-start text-center text-black dark:text-pink font-semibold">
          ...
          <div className="md:w-[50%] w-full flex justify-center lg:justify-start items-center gap-4">
            ...
            <button className="text-white dark:text-black text-[17px] bg-black dark:bg-pink w-[190px] py-3 rounded-xl hover:opacity-70">
              Connect Wallet
            </button>
            {/* trade now button */}
            <button className="text-black dark:text-pink text-[17px] border-[2px] border-solid border-black dark:border-pink w-[160px] py-[9px] rounded-xl hover:opacity-70">
              Trade Now
            </button>
          </div>
        </div>
