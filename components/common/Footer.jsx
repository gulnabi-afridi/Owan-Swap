    ...
    <div className="w-full min-h-[40px] bg-[#0a0a0a]">
      <div className="w-full max-w-[1200px] m-auto flex flex-col justify-center items-center md:items-start py-10 gap-8 px-4 md:px-0">
        ...
        <div className="flex gap-4 justify-center items-center">
          <TwitterIcon className="text-[white] cursor-pointer hover:opacity-70 " />
          <TelegramIcon className="text-[white] cursor-pointer hover:opacity-70 " />
        </div>
        {/* bottom line */}
        ...
        <div className="w-full flex flex-col md:gap-0 gap-6 md:flex-row justify-between items-center">
          <div className="flex justify-center items-center gap-4">
            {/* Language */}
            <LanguageIcon className="text-[white] text-[28px] hover:opacity-70 cursor-pointer" />
            {/* Setting icon */}
            <SettingsIcon className="text-[white] text-[28px] hover:opacity-70 cursor-pointer" />
          </div>
          <div className="flex justify-center items-center gap-6">
            ...
            {/*  button */}
            <button className="text-white text-[17px] bg-[#FFAA27] px-4 py-1 rounded-xl hover:opacity-70 flex justify-center items-center gap-2">
              Buy Ove
              <ArrowForwardIcon />
            </button>
          </div>
